...
//echo "<pre/>"; print_r($_POST);die();
    ...
    if (!empty($_POST["email"])) {
        $email = $_POST["email"];
        $dublicate = "SELECT email FROM users WHERE email ='$email'";
    ...
    if ($isformValid) {
        ...
        $sql1="INSERT INTO `users`(`first_name`, `last_name`, `email`, `status`, `password`, `country`, `state`, `city`, `address`) VALUES ('$firstname','$lastname','$email','$status','$newpassword','$countryname','$state','$city','$address')";
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                   ...
                                   <input type="password" class="form-control" name="password" placeholder="Enter password" value="<?php echo(!empty($_POST["password"]) ? $_POST['password'] : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control" name="confirmpassword"
                                           placeholder="Enter  confirmpassword" value="<?php echo(!empty($_POST["confirmpassword"]) ? $_POST['confirmpassword'] : ''); ?>">
                                    ...
                                    <select class="form-control" id="country-dropdown" name="country_name">
                                        ...
                                        if ($count > 0) {
                                            while ($row = mysqli_fetch_assoc($result)) {
                                                ...
                                                <option value="<?php echo $id; ?>"<?php echo (!empty($_POST["country_name"]) && $_POST["country_name"] == "$id") ? 'selected="selected"' : ""; ?>><?php echo $country; ?></option>
                                                <?php
                                            }
                                        }
                                        ?>

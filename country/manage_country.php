...
if (!empty($_GET['search'])) {
    ...
    $sql .= " WHERE country_name LIKE '%$search%'";
} else {
    $search ="";
}
...
<div class="content">
    <header class="page-header">
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                <h1 class="separator">Manage Country</h1>
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <th>
                                        <a href="manage_country.php?orderby=country_name&order=<?php echo $CountryName; ?>&limit=<?php echo $limit; ?>&page=<?php echo $page; ?>&search=<?php echo $search; ?>">Country Name</a><i
                                                class="la <?php echo($orderBy == 'country_name' ? ($order == 'asc' ? 'la-sort-asc' : 'la-sort-desc') : 'la-sort'); ?>"></i>
                                    </th>
                                    <th>
                                        <a href="manage_country.php?orderby=status&order=<?php echo $status; ?>&limit=<?php echo $limit; ?>&page=<?php echo $page; ?>&search=<?php echo $search; ?>">Status</a><i
                                ...
                                <tr>
                                    ...
                                    <td align="center">
                                        ...
                                        <a href="status.php?status=<?php echo $status; ?>&id=<?php echo $id; ?>&page=<?php echo $page; ?>"><span
                                                    class="badge <?php echo $status == "Active" ? "badge-success" : "badge-danger"; ?>"><?php echo $status; ?></span></a>
                                    </td>

                                    <td align="right">
                                        <a href="edit_country.php?id=<?php echo $id; ?>" class="btn btn-success btn-sm"><i
                                    ...
                                    <ul class="pagination float-right m-0" role="navigation">
                                        ...
                                        if ($page > 1) { ?>
                                            <li class="page-item" aria-disabled="true" aria-label="« Previous"><a
                                                        href="manage_country.php?page=<?php echo($page - 1); ?>&limit=<?php echo $limit; ?>&search=<?php echo $search; ?>">
                                        ...
                                        for ($i = 1; $i <= $total_page; $i++) { ?>
                                            ...
                                            <li class="page-item <?php echo ($page == "$i") ? 'active' : ''; ?>"
                                                aria-current="page"><a
                                                        href="manage_country.php?page=<?php echo $i; ?>&limit=<?php echo $limit; ?>&search=<?php echo $search; ?>"><span

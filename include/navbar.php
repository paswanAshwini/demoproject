        ...
        <ul class="navbar-nav nav-right">
            <li class="nav-item dropdown">
                <a class="nav-link nav-pill user-avatar" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                    <img src="<?php echo WWW_BASE; ?>/assets/img/avatars/1.jpg" class="w-35 rounded-circle" alt="Albert Einstein">
                </a>
                <div class="dropdown-menu dropdown-menu-right dropdown-menu-accout">
                    <div class="dropdown-header pb-3">
                        <div class="media d-user">
                            <img class="align-self-center mr-3 w-40 rounded-circle" src="<?php echo WWW_BASE; ?>/assets/img/avatars/1.jpg" alt="Albert Einstein">
                    ...
                    <a class="dropdown-item" href="<?php echo WWW_BASE; ?>logout.php"><i class="icon dripicons-lock-open"></i> Sign Out</a>
                </div>
            </li>
        </ul>
